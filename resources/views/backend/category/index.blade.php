...
<main class="content">
				<div class="container-fluid p-0">
					<div class="d-flex justify-content-between"> 
						<h1 class="h3 mb-3"><strong>Category Table</strong></h1>
						<div class="py-3">
							<a href="{{ route('category.create') }}" class="btn btn-secondary">Category Create <i class="align-middle" data-feather="plus-circle"></i></a>
						</div>
                    </div>
                    <div class="">
						<div class="card">
